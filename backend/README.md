...
## Project Structure
    ...
    ├── ent_cyber_insurance_43045  # Django project configurations
...
1. Clone this repo and `cd ent_cyber_insurance_43045`
...
2. Clone this repo and `cd ent_cyber_insurance_43045`
